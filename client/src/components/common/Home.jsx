          ...
          {isSignedIn === false && (
            <div className=" p-5 rounded-5">
              ...
              >
                ...
                />
                <div ref={containerRef} style={{ position: "absolute", bottom: "0px", fontSize: "40px" }}>
                  <VariableProximity
                    label={
                      "HabiFy makes habit-building fun with a gamified approach, rewarding users for staying consistent."
                    }
                    className={"variable-proximity-demo autsc"}
                    fromFontVariationSettings="'wght' 400, 'opsz' 30"
                    toFontVariationSettings="'wght' 1000, 'opsz' 90"
